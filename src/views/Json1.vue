...
oReq.open("GET", "https://api-tokyochallenge.odpt.org/api/v4/odpt:TrainInformation?odpt:operator=odpt.Operator:JR-East&acl:consumerKey=00275963aa9f34380bd6ea18cb650cc49439e042c73bdedb11ca0b114e8cd76e");
oReq.send();
